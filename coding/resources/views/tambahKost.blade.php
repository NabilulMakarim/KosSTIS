    ...
    <div class="card col-md-9 mx-auto mb-5">
        ...
        <div class="card-body">
            <div class="col-lg-10 mx-auto mb-3">
                {{-- <div class="col-lg-8"> --}}
                <form method="post" action="/kosts/tambahUpdateKost" class="mb-0" enctype="multipart/form-data">
                    ...
                    {{-- //Nomor rumah  --}}
                    <div class="mb-3">
                        <label for="no" class="form-label fw-bold">No.</label>
                    ...
                    {{-- //Gender  --}}
                    <div class="mb-3">
                        <label for="gender" class="form-label fw-bold">Gender Penghuni</label>
                    ...
                    {{-- //Dapur  --}}
                    <div class="mb-3">
                        <label for="ringkasan" class="form-label fw-bold">Dapur bersama</label>
                    ...
                    {{-- //Fasilitas Bersama --}}
                    <div class="mb-3">
                        <label for="fasilitas" class="form-label fw-bold">Fasilitas Kost Bersama</label>
                    ...
                    {{-- //No Hp pemilik  --}}
                    <div class="mb-3">
                        <label for="noHp" class="form-label fw-bold">Nomor HP pemilik kost</label>
                        <div class="input-group">
                    ...
                    {{-- //Gambar  --}}
                    <div class="mb-3">
                        <label for="image" class="form-label fw-bold">Gambar Kost (optional)</label>
                    ...
                    {{-- //deskripsi --}}
                    <div class="mb-3">
                        <label for="deskripsi" class="form-label fw-bold">Informasi lain terkait kost</label>
                        @error('deskripsi')
            ...
            <label for="#" class="form-label">Longitude</label> --}}
                    ...
                    <button type="submit" class="btn btn-primary">Ajukan Penambahan Data Kost</button>
