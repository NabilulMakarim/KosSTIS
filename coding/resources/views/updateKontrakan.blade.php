...
@section('container')
    ...
    <div class="card col-md-9 mx-auto mb-5">
        <h5 class="card-header">Update data kontrakan {{ $kontrakan->nama }}</h5>
        <div class="card-body">
            <div class="col-lg-10 mx-auto mb-3">
                {{-- <div class="pt-3 pb-2 mb-3">
          <h4 class="text-center text-decoration-underline">Kontrakan {{ $kontrakan->nama }}</h4>
        </div> --}}
                <form method="post" action="/ajukanUpdateKontrakan" class="mb-0" enctype="multipart/form-data">
                    ...
                    <input type="hidden" class="form-control" id="kelurahan" name="kelurahan" disable readonly required
                        autofocus value="{{ $kontrakan->kelurahan }}">
