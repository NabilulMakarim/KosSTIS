...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/kontrakans/tambahKontrakanAdmin" class="mb-0" enctype="multipart/form-data">
         ...
         @endforeach --}}
            ...
            {{-- //harga  --}}
            <div class="mb-3">
                <label for="harga" class="form-label">Kira-kira harga perbulan (misal: 1800000)</label>
       ...
       @enderror
            ...
            <button type="submit" class="btn btn-primary mb-3">Tambahkan Data Kontrakan</button>
        </form>
    </div>
