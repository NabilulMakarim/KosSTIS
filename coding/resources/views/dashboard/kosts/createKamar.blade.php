...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/kosts/tambahKamar" class="mb-0" enctype="multipart/form-data">
            ...
            {{-- //Id kost  --}}
            {{-- <div class="mb-3"> --}}
            {{-- <label for="kost_id" class="form-label">kost_id.</label> --}}
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('harga') is-invalid @enderror" id="harga"
                    name="harga" disable autofocus required value="{{ old('harga') }}">

                @if ($hargas)
                    <small>
                        Kamar yang sudah ada pada kost ini adalah kamar dengan harga
