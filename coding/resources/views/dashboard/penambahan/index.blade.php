...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Pengajuan Penambahan</h1>
    </div>
    ...
    <div class="row d-flex justify-content-between">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($kosts as $kost)
                                        <tr>
                                            ...
                                            <td class="col-md-2">
                                                <a href="/dashboard/penambahanKost/{{ $kost->id }}"
                    ...
                    @else
                        <div class="col-lg-12">
                            <p class="text-center fs-4">Tidak ada pengajuan penambahan kost</p>
                        </div>
                    @endif
        ...
        <div class="col-md-4">
            <div class="card">
                                ...
                                <tbody>
                                    @foreach ($kontrakans as $kontrakan)
                                        <tr>
                                            ...
                                            <td class="col-md-2">
                                                <a href="/dashboard/penambahanKontrakan/{{ $kontrakan->id }}"
                ...
                @csrf
                <button class="badge bg-warning border-0" onclick="return confirm('Apakah Anda yakin menerima penambahan data kontrakan ini?')"><span data-feather="edit" ></span></button>
              </form>
              <form Aksi="/dashboard/tolakKontrakan/{{ $kontrakan->id }}" method="post" class="d-inline">
                @method('delete')
                @csrf
                <button class="badge bg-danger border-0" onclick="return confirm('Apakah Anda yakin menolak penambahan data kontrakan ini?')"><span data-feather="x-circle" ></span></button>
              </form> --}}
                                            </td>
                                        </tr>
                                    @endforeach
                    ...
                    @else
                        <div class="col-lg-12">
                            <p class="text-center fs-4">Tidak ada pengajuan penambahan kontrakan</p>
                        </div>
                    @endif
        ...
        <div class="col-md-4">
            <div class="card">
              ...
              @endif           --}}
                                            ...
                                            <td class="col-md-2">
                                                <a href="/dashboard/penambahanKamar/{{ $kamar->id }}"
                                                    class="badge bg-secondary"><i class="fas fa-eye"></i></a>
                                                {{-- <form Aksi="/dashboard/terimaKontrakan/{{ $kontrakan->id }}" method="post" class="d-inline">
                @csrf
                <button class="badge bg-warning border-0" onclick="return confirm('Apakah Anda yakin menerima penambahan data kontrakan ini?')"><span data-feather="edit" ></span></button>
              ...
              <form Aksi="/dashboard/tolakKontrakan/{{ $kontrakan->id }}" method="post" class="d-inline">
                ...
                <button class="badge bg-danger border-0" onclick="return confirm('Apakah Anda yakin menolak penambahan data kontrakan ini?')"><span data-feather="x-circle" ></span></button>
                    ...
                    @else
                        <div class="col-lg-12">
                            <p class="text-center fs-4"> Tidak ada pengajuan penambahan kamar </p>
                        </div>
                    @endif
